...
# COPY distributed_2layer_subnet_partitioned_ps_gloo.py ./
#COPY distributed_2layer_subnet_centralized_ps_gloo.py ./
# COPY distributed_3layer_subnet_partitioned_ps_gloo.py ./
...
COPY --from=build ./ ./
# ENTRYPOINT ["python3", "./distributed_2layer_subnet_partitioned_ps_gloo.py"]
# CMD ["python3", "./distributed_2layer_subnet_partitioned_ps_gloo.py"]
...
# ENTRYPOINT ["python3", "./distributed_3layer_subnet_partitioned_ps_gloo.py"]
# CMD ["python3", "./distributed_3layer_subnet_partitioned_ps_gloo.py"]
